...
class music_cog(commands.Cog):
    def __init__(self, bot):
        ...
        self.music_queue = []
        self.YDL_OPTIONS = {'format': 'bestaudio', 'noplaylisty' : 'True'}
    ...
    async def play_music(self,ctx):
        if len(self.music_queue) > 0:
            self.is_playing = True
            m_url = self.music.queue[0][0]['source']
    ...
    @commands.command(name="resume", help="Resume the current song being played")
